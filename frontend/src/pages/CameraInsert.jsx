...
export default function CameraInsert() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      toast.error(err.response?.data?.message || '등록 중 오류가 발생했습니다.', {
        containerId: 'global',
      });
    }
  };
    ...
    <>
      <section className="ci-section">
        ...
        <table className="ci-table">
          <tbody>
            <tr>
              <th>스트리밍명 <span style={{ color: 'red' }}>*</span></th>
              <td>
        ...
        <table className="ci-table">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="categoryLarge" value={form.categoryLarge} onChange={handleChange} />
              </td>
              <th>중분류</th>
              <td>
                <input type="text" name="categoryMedium" value={form.categoryMedium} onChange={handleChange} />
              </td>
            </tr>
            <tr>
              <th>소분류</th>
              <td>
                <input type="text" name="categorySmall" value={form.categorySmall} onChange={handleChange} />
              </td>
              <th>스트리밍 URL <span style={{ color: 'red' }}>*</span></th>
              <td>
                <input type="text" name="streamingUrl" value={form.streamingUrl} onChange={handleChange} />
              </td>
            </tr>
            <tr>
              <th>유형 <span style={{ color: 'red' }}>*</span></th>
              <td>
                <input type="text" name="cameraType" value={form.cameraType} onChange={handleChange} />
              </td>
              <th>주소</th>
              <td>
